...
getMovePossibilities[{pawn:"\[WhitePawn]"|"\[BlackPawn]",{x_,y_},moved_},ignoreOthers_: False]:= Return[Select[movePawn[{pawn,{x,y}, moved},x,y],isPlacementAllowed[#,getColor[pawn],{pawn, {x, y}, moved}]&]]
getMovePossibilities[{bishop:"\[WhiteBishop]"|"\[BlackBishop]",{x_,y_},moved_},ignoreOthers_: False]:= Return[Select[moveBishop[{bishop,{x,y}},x,y],isPlacementAllowed[#,getColor[bishop],{bishop, {x, y}, moved}]&]]
getMovePossibilities[{knight:"\[WhiteKnight]"|"\[BlackKnight]",{x_,y_},moved_},ignoreOthers_: False]:= Return[Select[moveKnight[{knight,{x,y}},x,y],isPlacementAllowed[#,getColor[knight],{knight, {x, y}, moved}]&]]
getMovePossibilities[{queen:"\[WhiteQueen]"|"\[BlackQueen]",{x_,y_},moved_},ignoreOthers_: False]:= Return[Select[moveQueen[{queen,{x,y}},x,y],isPlacementAllowed[#,getColor[queen],{queen, {x, y}, moved}]&]]
getMovePossibilities[{king:"\[WhiteQueen]"|"\[BlackQueen]",{x_,y_},moved_},ignoreOthers_: False]:= Return[Select[moveKing[{king,{x,y}, moved},x,y],isPlacementAllowed[#,getColor[king],{king, {x, y}, moved}]&]]
getMovePossibilities[{rook:"\[WhiteQueen]"|"\[BlackQueen]",{x_,y_},moved_},ignoreOthers_: False]:= Return[Select[moveRook[{rook,{x,y}, moved},x,y],isPlacementAllowed[#,getColor[rook],{rook, {x, y}, moved}]&]]
...
nlist = {};
Table[(Print[isPlacementAllowed[list[[i]], getColor[king[[1]]], king]];If[isPlacementAllowed[list[[i]], getColor[king[[1]]], king], AppendTo[nlist, list[[i]]]]), {i, 1, Length[list]}];
ennemies = {};
If[!ignoreOthers, (
Table[Table[
